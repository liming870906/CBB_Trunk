 ...
 */
public class TTProgressDialog extends TTAlertDialog {
    
    /** Creates a LFProgressDialog with a circular, spinning progress
     * bar. This is the default.
     */
    public static final int STYLE_SPINNER = 0;
    
    /** Creates a LFProgressDialog with a horizontal progress bar.
     */
    ...
    public TTProgressDialog(Context context, int theme) {
        super(context, theme);
        mContext = context;
        initFormats();
    }
    ...
    public static TTProgressDialog show(Context context, CharSequence title,
    ...
    public static TTProgressDialog show(Context context, CharSequence title,
        ...
        TTProgressDialog dialog = new TTProgressDialog(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mProgressStyle == STYLE_HORIZONTAL) {
            ...
            View view = inflater.inflate(R.layout.tt_alert_progress_dialog, null);
            mProgress = (ProgressBar) view.findViewById(R.id.progress);
            mProgressNumber = (TextView) view.findViewById(R.id.progress_number);
            mProgressPercent = (TextView) view.findViewById(R.id.progress_percent);
            setView(view, true);
        } else {
            View view = inflater.inflate(R.layout.tt_progress_dialog, null);
            mProgress = (ProgressBar) view.findViewById(R.id.progress);
